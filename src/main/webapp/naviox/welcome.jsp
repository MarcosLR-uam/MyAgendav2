...
In MyAgendaV3-labels_en.properties:
MyAgendaV3=My application
MyAgendaV3[description]=My application does this and that

In MyAgendaV3-messages_en.properties:
